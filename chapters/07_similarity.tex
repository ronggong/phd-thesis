...
The describe the pronunciation and overall quality similarities measurement task in this section, which is continued building on the problem formulation presented in \secref{sec:ch3:similarity_formulation}.
